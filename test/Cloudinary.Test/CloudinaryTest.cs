...
namespace CloudinaryDotNet.Test
{
    public class CloudinaryTest : IntegrationTestBase
    {
        ...
        [Test, Ignore("Waiting for decision. HttpClient doesn't support of Content-Range header in request message.")]
        ...
        public void TestGetResource()
        {
            ...
            Assert.IsNotEmpty(getResult.Phash);
        }
        ...
        public void TestRestoreNoBackup()
        {
            ...
            Assert.NotNull(rResult.JsonObj[TEST_PUBLIC_ID]);
        ...
        public void TestRestore()
        {
            ...
            Assert.NotNull(rResult_backup.JsonObj[TEST_PUBLIC_ID]);
        ...
        public void TestAgentPlatformHeaders()
        {
            ...
            var agent = string.Join(" ", headers);

            Assert.That(agent, Is.EqualTo(string.Format("{0} {1}", m_cloudinary.Api.UserPlatform, Api.USER_AGENT)).IgnoreCase);
            Assert.That(agent, Does.Match(@"Test\/1\.0 CloudinaryDotNet\/(\d+)\.(\d+)\.(\d+)"));
        }
        ...
        public void TestExplicitInvalidate()
        {
            ...
            {
                p.Api.PrepareRequestBody(CloudinaryDotNet.HttpMethod.POST, "http://localhost", t.ToParamsDictionary(), null);
        ...
        public void TestUnsignedUpload()
        {
            ...
            var acc = new Account(this.m_cloudName);
        ...
        public void TestResponsiveBreakpointsToJson()
        {
            ...
            Assert.AreEqual("{\"create_derived\":true}", responsiveBreakpoint);
            ...
            Assert.That(actualList1, Is.EquivalentTo(expectedList1));
            ...
            Assert.That(actualList2, Is.EquivalentTo(expectedList2));
        }
        ...
        public void TestTextAlign()
        {
            ...
            {
                p.Api.PrepareRequestBody(HttpMethod.POST, "http://localhost", t.ToParamsDictionary(), null);
                return (TextResult)null;
            });
