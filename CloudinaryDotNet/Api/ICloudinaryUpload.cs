namespace CloudinaryDotNet
{
    ...
    /// <summary>
    /// Main class of Cloudinary .NET Upload API.
    /// </summary>
    public interface ICloudinaryUpload
    {
        ...
        Task<RawUploadResult> UploadLargeRawAsync(
            ...
            int bufferSize = CloudinaryUpload.DEFAULT_CHUNK_SIZE,
            CancellationToken? cancellationToken = null);
        ...
        /// </exception>
        RawUploadResult UploadLargeRaw(BasicRawUploadParams parameters, int bufferSize = CloudinaryUpload.DEFAULT_CHUNK_SIZE);
        ...
        /// <param name="bufferSize">Chunk (buffer) size (20 MB by default).</param>
        /// <returns>Parsed result of uploading.</returns>
        RawUploadResult UploadLarge(RawUploadParams parameters, int bufferSize = CloudinaryUpload.DEFAULT_CHUNK_SIZE);
        ...
        /// <param name="bufferSize">Chunk (buffer) size (20 MB by default).</param>
        /// <returns>Parsed result of uploading.</returns>
        ImageUploadResult UploadLarge(ImageUploadParams parameters, int bufferSize = CloudinaryUpload.DEFAULT_CHUNK_SIZE);
        ...
        /// <param name="bufferSize">Chunk (buffer) size (20 MB by default).</param>
        /// <returns>Parsed result of uploading.</returns>
        VideoUploadResult UploadLarge(VideoUploadParams parameters, int bufferSize = CloudinaryUpload.DEFAULT_CHUNK_SIZE);
        ...
        /// <param name="bufferSize">Chunk (buffer) size (20 MB by default).</param>
        /// <returns>Parsed result of uploading.</returns>
        T UploadLarge<T>(BasicRawUploadParams parameters, int bufferSize = CloudinaryUpload.DEFAULT_CHUNK_SIZE)
            where T : UploadResult, new();
        ...
        string DownloadZip(string tag, Transformation transform, string resourceType = CloudinaryUpload.RESOURCE_TYPE_IMAGE);
        ...
        /// <param name="cancellationToken">(Optional) Cancellation token.</param>
        /// <returns>The public id of the generated slideshow.</returns>
        Task<CreateSlideshowResult> CreateSlideshowAsync(
                CreateSlideshowParams parameters,
                CancellationToken? cancellationToken = null);
        ...
        string GetCloudinaryJsConfig(bool directUpload = false, string dir = "");
    }
}
