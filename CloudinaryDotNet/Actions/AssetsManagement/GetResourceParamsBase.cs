namespace CloudinaryDotNet.Actions
{
    ...
    /// </summary>
    public abstract class GetResourceParamsBase : BaseParams
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetResourceParamsBase"/> class.
        /// </summary>
        public GetResourceParamsBase()
        {
            Type = "upload";
            Exif = false;
            Colors = false;
