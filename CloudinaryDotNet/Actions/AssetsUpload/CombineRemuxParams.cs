namespace CloudinaryDotNet.Actions
{
    ...
    /// <summary>
    /// Parameters for combining and remuxing remote video chunks into a single MP4 asset.
    /// Mirrors POST /v1_1/{cloud}/video/combine_remux.
    /// The combine/remux runs asynchronously on the server; the final upload result is delivered via
    ...
    /// </summary>
    public class CombineRemuxParams : VideoUploadParams
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the ordered list of HTTP(S) URLs of the video chunks to concatenate, in playback order.
        /// </summary>
