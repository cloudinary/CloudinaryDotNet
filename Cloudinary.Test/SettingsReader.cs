...
namespace Cloudinary.Test
{
    ...
    {
        private const string SETTINGS_XPATH = "/configuration/applicationSettings/Cloudinary.Test.Properties.Settings/setting[@name='_val_']/value";
        ...
        public static string ReadSetting(string settingName)
        {
            ...
            XmlNode node = doc.DocumentElement.SelectSingleNode(SETTINGS_XPATH.Replace("_val_", settingName));
            if(node == null)
