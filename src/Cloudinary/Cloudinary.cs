...
namespace CloudinaryDotNet
{
    ...
    public partial class Cloudinary
    {
        ...
        public ExplicitResult Explicit(ExplicitParams parameters)
        {
            ...
            using (HttpResponseMessage response = m_api.Call(HttpMethod.POST, uri, parameters.ToParamsDictionary(), null))
            {
        ...
        public UploadPresetResult CreateUploadPreset(UploadPresetParams parameters)
        {
            ...
            using (HttpResponseMessage response = m_api.Call(HttpMethod.POST, url, parameters.ToParamsDictionary(), null))
            {
        ...
        public UploadPresetResult UpdateUploadPreset(UploadPresetParams parameters)
        {
            ...
            using (HttpResponseMessage response = m_api.Call(HttpMethod.PUT, url, @params, null))
            {
                return UploadPresetResult.Parse(response);
            }
        }
        ...
        public GetUploadPresetResult GetUploadPreset(string name)
        {
            ...
            using (HttpResponseMessage response = m_api.Call(HttpMethod.GET, url, null, null))
            {
        ...
        public ListUploadPresetsResult ListUploadPresets(ListUploadPresetsParams parameters)
        {
            ...
            using (HttpResponseMessage response = m_api.Call(HttpMethod.GET, urlBuilder.ToString(), null, null))
            {
        ...
        public DeleteUploadPresetResult DeleteUploadPreset(string name)
        {
            ...
            using (HttpResponseMessage response = m_api.Call(HttpMethod.DELETE, url, null, null))
            {
        ...
        public ImageUploadResult Upload(ImageUploadParams parameters)
        {
            ...
            using (HttpResponseMessage response = m_api.Call(HttpMethod.POST, uri, parameters.ToParamsDictionary(), parameters.File))
            {
        ...
        public RawUploadResult Upload(string resourceType, IDictionary<string, object> parameters, FileDescription fileDescription)
        {
            ...
            using (HttpResponseMessage response = m_api.Call(HttpMethod.POST, uri, (SortedDictionary<string, object>)parameters, fileDescription))
            {
        ...
        public UsageResult GetUsage()
        {
            ...
            using (HttpResponseMessage response = m_api.Call(HttpMethod.GET, uri, null, null))
            {
        ...
        public UploadResult UploadLarge(BasicRawUploadParams parameters, int bufferSize = 20 * 1024 * 1024, bool isRaw = false)
        {
            ...
            while (!parameters.File.EOF)
            {
                ...
                using (HttpResponseMessage response = m_api.Call(HttpMethod.POST, uri, apiParams, parameters.File, extraHeaders))
                {
                    if (isRaw)
