namespace CloudinaryDotNet.Actions
{
    ...
    {
        /// <summary>
        /// Optional. A unique immutable identification string for the metadata field.
        ...
        /// <summary>
        /// Optional. Whether a value must be given for this field, either when an asset is first uploaded,
        /// or when it is updated. Default: false.
        /// </summary>
        public bool Mandatory { get; set; }

        /// <summary>
        /// The default value for the field (a set can have multiple default values defined by an array).
    ...
    public class DateMetadataFieldCreateParams : MetadataFieldCreateParams<DateTime?>
    {
        ...
        protected override void AddParamsToDictionary(SortedDictionary<string, object> dict)
        {
            ...
            if (DefaultValue != null)
            {
                AddParam(dict, "default_value", DefaultValue.Value.ToString("yyyy-MM-dd"));
            }
        }
    }
    ...
    {
        /// <summary>
        /// The minimum string length, represented by a positive integer.
        /// Default value: 0.
        /// </summary>
        public int? Min { get; set; }

        /// <summary>
        /// The maximum string length, represented by a positive integer.
        /// Default value: 1024.
        /// </summary>
    ...
    public abstract class ComparisonValidationParams<T> : MetadataValidationParams
    {
        ...
        /// <summary>
        /// Whether to check if greater than or equals.
        /// Default value: false.
        /// </summary>
    ...
    public class DateGreaterThanValidationParams : ComparisonValidationParams<DateTime>
    {
        ...
        {
            base.AddParamsToDictionary(dict);
            dict.Add("value", Value.ToString("yyyy-MM-dd"));
        }
    }
    ...
    public class DataSourceEntriesParams : BaseParams
    {
        ...
        /// <summary>
        /// An array of IDs of datasource entries to delete.
        /// </summary>
